  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '2.0.21' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 2.0.21 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
    ...
    if (process.arch === 'x64') {
      if (process.config?.variables?.shlib_suffix === 'dll.a' || process.config?.variables?.node_target_type === 'shared_library') {
        try {
        return require('./workspace-tools.win32-x64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./workspace-tools.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./workspace-tools.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./workspace-tools.openharmony-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./workspace-tools.openharmony-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./workspace-tools.openharmony-arm.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  try {
    wasiBinding = require('./workspace-tools.wasi.cjs')
  ...
  if (!nativeBinding) {
    try {
      wasiBinding = require('@websublime/workspace-tools-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
...
module.exports.configShow = nativeBinding.configShow
module.exports.configValidate = nativeBinding.configValidate
