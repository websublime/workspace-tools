...
This library is designed for Rust applications that interact with Node.js package ecosystems such as package managers, monorepo tools, or dependency analysis utilities.
...
```rust
use sublime_package_tools::{VersionError, PackageError, DependencyResolutionError};
